...
# file every `config_poll_interval_sec` seconds and applies changes without
# restart (FR-25). In-flight subprocesses are NEVER killed by a config
# change (FR-26, FR-27).
"""
