...
CREATE TABLE IF NOT EXISTS questions (
    ...
    answer         TEXT,                              -- JSON (list if multi_select, else string)
...
class QuestionStore:
    ...
    def answer(self, qid: str, answer: Any, answered_by: str = "operator") -> bool:
        ...
        with self._conn() as conn:
            cur = conn.execute(
                ...
                (_dumps(answer), answered_by, time.time(), qid),
            )
